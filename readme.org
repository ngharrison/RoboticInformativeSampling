...
The purpose of this repository is mainly to serve as a reference implementation for the methods in [[https://hdl.handle.net/2123/34094][my thesis]]. However, the code is organized and documented to make it easier for others to use and build off it. In particular, it contains two reusable submodules that contain core informative sampling and utility pieces. If you have questions about the code or problems trying to use it, feel free to post in the Discussions or Issues, and I'll see how I can help.
